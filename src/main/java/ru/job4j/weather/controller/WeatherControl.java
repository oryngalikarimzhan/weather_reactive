...
public class WeatherControl {
    ...
    @GetMapping(value = "/city/hottest")
    public Mono<Weather> getHottest() {
        return weathers.findHottest();
    }

    @GetMapping(value = "/city/hotter_than/{temp}}")
    public Flux<Weather> getAllHotterThan(@PathVariable Integer temp) {
        return weathers.findAllHotterThan(temp);
    }
